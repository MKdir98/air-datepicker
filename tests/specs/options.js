describe('Options', function () {
    ...
    describe('startDate', function () {
        it('should change initial viewing date', function () {
            dp = $input.datepicker({
                startDate: new JalaliDate(2014,11,12)
            }).data('datepicker');
    ...
    describe('dateFormat', function () {
        var date = new JalaliDate(2015, 6, 4, 11, 5),
            formats = {
                '@': date.getTime(),
                'aa': 'am',
                'AA': 'AM',
        ...
        it('should work with special characters', function () {
            ...
            dp.selectDate(new JalaliDate(2016, 2, 1));
    ...
    describe('altFieldFormat', function () {
        it('should define date format for alternative field', function () {
            var date = new JalaliDate(2015, 11, 17);
        ...
        it('should support 24 hour mode, even if main date format is in 12', function () {
            var date = new JalaliDate(2015, 11, 17, 22, 47);
    ...
    describe('showOtherMonths', function () {
        var date = new JalaliDate(2015, 11, 22);
    ...
    describe('minDate', function () {
        it('should set minimum possible date to choose', function () {
            var date = new JalaliDate(2015, 11, 30);
    ...
    describe('multipleDates', function () {
        it('if `true` then one can select multiple dates', function () {
            ...
            dp.selectDate(new JalaliDate(2016, 0, 7));
            dp.selectDate(new JalaliDate(2016, 0, 8));
            dp.selectDate(new JalaliDate(2016, 0, 9));
        ...
        it('if `number` should limit length of selected dates by its value', function () {
            ...
            dp.selectDate(new JalaliDate(2016, 0, 8));
            dp.selectDate(new JalaliDate(2016, 0, 9));
            dp.selectDate(new JalaliDate(2016, 0, 10));
            dp.selectDate(new JalaliDate(2016, 0, 11));
    ...
    describe('multipleDatesSeparator', function () {
        it('defines multiple dates separator sign', function () {
            ...
            dp.selectDate(new JalaliDate(2016, 0, 12));
            dp.selectDate(new JalaliDate(2016, 0, 13))
    ...
    describe('dateTimeSeparator', function () {
        it('should define separator between date string and time', function () {
            var date = new JalaliDate(2016,2,9,11,24);
            dp = $input.datepicker({
                timepicker: true,
    ...
    describe('timeFormat', function () {
        it('should define time format', function () {
            var date = new JalaliDate(2016,2,9,9,4);
            dp = $input.datepicker({
                timepicker: true,
                timeFormat: 'h - ii',
                onSelect: function (fd, d) {
